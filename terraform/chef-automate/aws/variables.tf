...
variable "automate_products" {
  default     = "--product automate --product builder --product infra-server"
  description = "default Automate only options as follows: --product automate --product builder --product infra-server"
}